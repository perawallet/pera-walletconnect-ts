import type { NetworkEvent, INetworkEventEmitter, INetworkMonitor } from "../types";
...
class NetworkMonitor implements INetworkMonitor {
  ...
  constructor() {
    ...
    // oxlint-disable-next-line typescript/no-explicit-any -- legacy runtime capability check
